...
FILES="src/am/am.c src/am/ambuild.c src/am/amvacuum.c src/am/amscan.c src/pages/trgm_page.c src/query/doc.c src/query/analyze.c src/query/tsanalyze.c src/vector/vecwrite.c src/vector/vecshuttle.c src/query/gate.c"

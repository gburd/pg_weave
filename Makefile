...
# needed here.
REGRESS = weave unicode_fold idx_scan_stats wvec orderby chandesc surf vecindex vecscan pendingvec chanstats fuzzyuleven regexdict edist cgram

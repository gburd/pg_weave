        ...
        tapCheckFor = pg:
          ...
          in pkgs.stdenv.mkDerivation {
            ...
            buildPhase = ''
              ...
              # format-v6 upgrade, chandesc corruption). The
              ...
              make installcheck REGRESS= ISOLATION= \
                PROVE_TESTS='t/003_corruption.pl t/004_encodings.pl t/005_concurrency.pl t/006_concurrent_extend.pl t/007_segment_cap.pl t/008_vacuum_reclaim.pl t/009_doclen_sidecar.pl t/010_format_v6_upgrade.pl t/011_chandesc_corruption.pl' \

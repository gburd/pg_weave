...
no per-host A/B. V7-V14 not started. **V16 done 2026-09-15** -- the approximate kernel family now exists (`lut-byte`, 5x, and `best()` cannot select it because the approximation is only sound with a rerank that V7/V8 have not built yet) -- **V15 re-scoped rather than demoted**, and **V17 opened** for the dim sweep V16 left owed.

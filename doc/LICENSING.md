...
| Sparsemap (succinct bitmap, used for tombstones and trigram postings) | `src/util/sparsemap.c`, `include/weave/sparsemap_impl.h` | vendored at the fork; header says v5.5.0 (SM_VERSION_STRING). Upstream has 5.5.1, qualified by the project this was forked from; the 5.5.0->5.5.1 delta is an ENOSPC return on __sm_append_data and is NOT implicated in the merge tombstone P0 | **MIT**, © 2024 Gregory Burd | vendored, symbols namespaced |
